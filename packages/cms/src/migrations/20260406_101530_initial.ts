...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_posts_category" AS ENUM('blog', 'news', 'case-study');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_category" AS ENUM('blog', 'news', 'case-study');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('linkedin', 'twitter', 'instagram', 'github', 'youtube');
  CREATE TYPE "public"."enum_site_settings_theme" AS ENUM('minimal', 'bold', 'corporate');
  ...
  CREATE TABLE "pages_blocks_portfolio_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_pages_v_blocks_portfolio_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"theme" "enum_site_settings_theme" DEFAULT 'minimal' NOT NULL,
  	"site_name" varchar DEFAULT 'My OpenKERN Site' NOT NULL,
  ...
  ALTER TABLE "pages_blocks_portfolio_items" ADD CONSTRAINT "pages_blocks_portfolio_items_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "pages_blocks_portfolio_items" ADD CONSTRAINT "pages_blocks_portfolio_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages_blocks_portfolio"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_pages_v_blocks_portfolio_items" ADD CONSTRAINT "_pages_v_blocks_portfolio_items_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_pages_v_blocks_portfolio_items" ADD CONSTRAINT "_pages_v_blocks_portfolio_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v_blocks_portfolio"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "pages_blocks_portfolio_items_order_idx" ON "pages_blocks_portfolio_items" USING btree ("_order");
  CREATE INDEX "pages_blocks_portfolio_items_parent_id_idx" ON "pages_blocks_portfolio_items" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_portfolio_items_image_idx" ON "pages_blocks_portfolio_items" USING btree ("image_id");
  ...
  CREATE INDEX "_pages_v_blocks_portfolio_items_order_idx" ON "_pages_v_blocks_portfolio_items" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_portfolio_items_parent_id_idx" ON "_pages_v_blocks_portfolio_items" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_portfolio_items_image_idx" ON "_pages_v_blocks_portfolio_items" USING btree ("image_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_portfolio_items" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_portfolio_items" CASCADE;
